...
class MainProcess:
    ...
    def run(self):
        ...
        extract_ques_df = FileManager.read_csv(f"/content/ques_to_extract_from_{self.file_type}_sec_files_using_llm.csv")
...
if __name__ == "__main__":
    process = MainProcess(r'/content/config.ini', r'/content/pdfs',
                          r'/content/llm_output','10-K')
    process.run()
